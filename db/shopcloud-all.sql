create database IF NOT EXISTS `shop4cloud_auth` default character set utf8 collate utf8_general_ci;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '统一账户信息';
...
create database IF NOT EXISTS `shop4cloud_biz` default character set utf8 collate utf8_general_ci;
...
create database IF NOT EXISTS `shop4cloud_leaf` default character set utf8 collate utf8_general_ci;
...
-- ----------------------------
INSERT INTO `leaf_alloc` VALUES ('shop4cloud-auth-account', 112000, 100, '2021-07-01 14:16:40', 'shop4cloud-multishop数据库中auth_account这张表的uid', 10);
INSERT INTO `leaf_alloc` VALUES ('shop4cloud-multishop-user', 110400, 100, '2021-07-01 11:10:32', 'shop4cloud-multishop数据库中shop_user这张表的id', 10);
INSERT INTO `leaf_alloc` VALUES ('shop4cloud-order', 1568693084, 100, '2021-07-05 15:25:19', '订单id', 10);
INSERT INTO `leaf_alloc` VALUES ('shop4cloud-pay', 564994845, 100, '2021-07-05 15:14:40', '支付单号', 10);
INSERT INTO `leaf_alloc` VALUES ('shop4cloud-platform-user', 101600, 100, '2021-07-03 13:13:54', 'shop4cloud-platform数据库中sys_user这张表的id', 10);
INSERT INTO `leaf_alloc` VALUES ('shop4cloud-user', 106600, 100, '2021-07-01 11:22:26', 'shop4cloud-user数据库中user这张表的id', 10);


create database IF NOT EXISTS `shop4cloud_multishop` default character set utf8 collate utf8_general_ci;

USE shop4cloud_multishop;
...
create database IF NOT EXISTS `shop4cloud_nacos` default character set utf8 collate utf8_general_ci;

USE shop4cloud_nacos;
...
-- ----------------------------
INSERT INTO `config_info` VALUES (2, 'application-dev.yml', 'DEFAULT_GROUP', '# 数据源\nspring:\n  #避免nacos取网卡出错\n  cloud:\n    inetutils:\n      preferred-networks: 192.168.1\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    type: com.zaxxer.hikari.HikariDataSource\n    hikari:\n      minimum-idle: 0\n      maximum-pool-size: 20\n      idle-timeout: 25000\n      auto-commit: true\n      connection-test-query: SELECT 1\n  redis:\n    host: 192.168.1.49\n    # password: null\n  jackson:\n    date-format: yyyy-MM-dd HH:mm:ss\n    time-zone: GMT+8\n      \n#mybatis的相关配置\nmybatis:\n  #mapper配置文件\n  mapper-locations: classpath:mapper/*Mapper.xml\n  type-aliases-package: com.shop4j.cloud.**.model\n  #开启驼峰命名\n  configuration:\n    map-underscore-to-camel-case: true\n\nseata:\n  config:\n    type: nacos\n    nacos:\n      namespace: 4b70485d-72dd-44df-a76a-7a3f578a3001\n      server-addr: ${spring.cloud.nacos.discovery.server-addr}\n      password: ${spring.cloud.nacos.discovery.password}\n      username: ${spring.cloud.nacos.discovery.username}\n  registry:\n    type: nacos\n    nacos:\n      server-addr: ${spring.cloud.nacos.discovery.server-addr}\n      username: ${spring.cloud.nacos.discovery.username}\n      password: ${spring.cloud.nacos.discovery.password}\n      namespace: ${seata.config.nacos.namespace}\n\nlogging:\n  level:\n    root: info\n    com:\n      shop4cloud:\n        shop: debug\n# 分页合理化，当查询到页码大于最后一页的时候，返回最后一页的数据，防止vue在最后一页删除时，数据不对的问题\npagehelper:\n  reasonable: true\n\nbiz:\n  oss:\n    # resources-url是带有bucket的\n    resources-url: http://192.168.1.49:9000/shop4cloud\n    type: 1\n    endpoint: http://192.168.1.49:9000\n    bucket: shop4cloud\n    access-key-id: admin\n    access-key-secret: admin123456\n\nfeign:\n  client:\n    config:\n      default:\n        connectTimeout: 5000\n        readTimeout: 5000\n        loggerLevel: basic\n  inside:\n    key: shop4cloud-feign-inside-key\n    secret: shop4cloud-feign-inside-secret\n    # ip白名单，如果有需要的话，用小写逗号分割\n    ips: \n\nshop4cloud:\n  job:\n    accessToken:\n    admin:\n      addresses: http://192.168.1.49:8999\n\nrocketmq:\n  name-server: 192.168.1.49:9876', 'bc01547fe2e5ada0aa489dfd10a35839', '2020-09-07 05:54:23', '2021-07-31 11:20:32', 'nacos', '192.168.1.11', '', '', '', '', '', 'yaml', '');
INSERT INTO `config_info` VALUES (8, 'shop4cloud-auth.yml', 'DEFAULT_GROUP', '# 数据源\nspring:\n  datasource:\n    url: jdbc:mysql://${MYSQL_HOST:106.14.182.139}:${MYSQL_PORT:3306}/${MYSQL_DATABASE:shop4cloud_auth}?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=GMT%2B8&allowMultiQueries=true&allowPublicKeyRetrieval=true&useAffectedRows=true\n    username: ${MYSQL_USERNAME:root}\n    password: ${MYSQL_PASSWORD:root}\n\n# 用于token aes签名的key，16位\nauth:\n  token:\n    signKey: -shop4-shop4-shop4- ', '56d607c86e383e27174c8b7ce2e690bb', '2020-09-07 06:05:57', '2021-07-31 11:21:33', 'nacos', '192.168.1.11', '', '', '', '', '', 'yaml', '');
INSERT INTO `config_info` VALUES (13, 'shop4cloud-multishop.yml', 'DEFAULT_GROUP', '# 数据源\nspring:\n  datasource:\n    url: jdbc:mysql://${MYSQL_HOST:106.14.182.139}:${MYSQL_PORT:3306}/${MYSQL_DATABASE:shop4cloud_multishop}?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=GMT%2B8&allowMultiQueries=true&allowPublicKeyRetrieval=true&useAffectedRows=true\n    username: ${MYSQL_USERNAME:root}\n    password: ${MYSQL_PASSWORD:root}', 'e6e62d5a4d40101dc899cc37aecf7306', '2020-09-07 06:38:01', '2021-07-31 11:21:45', 'nacos', '192.168.1.11', '', '', '', '', '', 'yaml', '');
INSERT INTO `config_info` VALUES (16, 'shop4cloud-leaf.yml', 'DEFAULT_GROUP', '# 数据源\nspring:\n  datasource:\n    url: jdbc:mysql://${MYSQL_HOST:106.14.182.139}:${MYSQL_PORT:3306}/${MYSQL_DATABASE:shop4cloud_leaf}?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=GMT%2B8&allowMultiQueries=true&allowPublicKeyRetrieval=true&useAffectedRows=true\n    username: ${MYSQL_USERNAME:root}\n    password: ${MYSQL_PASSWORD:root}', 'f416d9ca7750b8cf5b78154e008233e8', '2020-09-07 06:44:22', '2021-07-31 11:21:55', 'nacos', '192.168.1.11', '', '', '', '', '', 'yaml', '');
INSERT INTO `config_info` VALUES (18, 'shop4cloud-rbac.yml', 'DEFAULT_GROUP', 'spring:\n  datasource:\n    url: jdbc:mysql://${MYSQL_HOST:106.14.182.139}:${MYSQL_PORT:3306}/${MYSQL_DATABASE:shop4cloud_rbac}?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=GMT%2B8&allowMultiQueries=true&allowPublicKeyRetrieval=true&useAffectedRows=true\n    username: ${MYSQL_USERNAME:root}\n    password: ${MYSQL_PASSWORD:root}\n', 'd33047562436e609a37c493ad337ca85', '2020-09-07 06:47:49', '2021-07-31 11:22:04', 'nacos', '192.168.1.11', '', '', '', '', '', 'yaml', '');
INSERT INTO `config_info` VALUES (31, 'shop4cloud-biz.yml', 'DEFAULT_GROUP', '# 数据源\nspring:\n  datasource:\n    url: jdbc:mysql://${MYSQL_HOST:106.14.182.139}:${MYSQL_PORT:3306}/${MYSQL_DATABASE:shop4cloud_biz}?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=GMT%2B8&allowMultiQueries=true&allowPublicKeyRetrieval=true&useAffectedRows=true\n    username: ${MYSQL_USERNAME:root}\n    password: ${MYSQL_PASSWORD:root}\n\nbiz:\n  oss:\n    # resources-url是带有bucket的\n    resources-url: http://106.14.182.139:9000/shop4cloud\n    # 文件上传类型 0.阿里云 1.minio\n    type: 1\n    endpoint: http://106.14.182.139:9000\n    bucket: shop4cloud\n    access-key-id: admin\n    access-key-secret: admin123456', '4619160fe2cdd49f21ccc7327dfe6857', '2020-09-10 07:26:09', '2021-07-31 11:22:21', 'nacos', '192.168.1.11', '', '', '', '', '', 'yaml', '');
INSERT INTO `config_info` VALUES (72, 'shop4cloud-product.yml', 'DEFAULT_GROUP', '# 数据源\nspring:\n  datasource:\n    url: jdbc:mysql://${MYSQL_HOST:106.14.182.139}:${MYSQL_PORT:3306}/${MYSQL_DATABASE:shop4cloud_product}?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=GMT%2B8&allowMultiQueries=true&allowPublicKeyRetrieval=true&useAffectedRows=true\n    username: ${MYSQL_USERNAME:root}\n    password: ${MYSQL_PASSWORD:root}', '2d7d7afa8b27e6044377a4a3d584885a', '2020-11-11 09:35:20', '2021-07-31 11:22:45', 'nacos', '192.168.1.11', '', '', '', '', '', 'yaml', '');
INSERT INTO `config_info` VALUES (73, 'shop4cloud-search.yml', 'DEFAULT_GROUP', 'elastic:\n  # elastic的地址\n  address: http://106.14.182.139:9200', '0e8ea5c03a559a26407a21e0efcc6a97', '2020-11-12 06:57:25', '2021-04-02 15:13:25', NULL, '', '', '', '', '', '', 'yaml', '');
INSERT INTO `config_info` VALUES (84, 'shop4cloud-gateway.yml', 'DEFAULT_GROUP', 'spring:\n  cloud:\n    gateway:\n      globalcors:\n        cors-configurations:\n          \'[/**]\':\n            allow-credentials: true\n            allowed-headers: \"*\"\n            # 半个月内都允许\n            max-age: 1296000\n            # 测试环境，全部允许\n            allowedOriginPatterns: \"*\"\n            # allowedOrigins:\n              # - \"http://localhost:9527\"\n              # - \"http://localhost:9527\"\n              # - \"http://localhost:9528\"\n              # - \"http://localhost:9529\"\n              # - \"http://:9527\"\n            allowedMethods:\n              - GET\n              - POST\n              - PUT\n              - OPTIONS\n              - DELETE\n      discovery:\n        locator:\n          # 开启服务注册和发现\n          enabled: true\n          # 不手动写路由的话，swagger整合不了...\n      routes:\n        - id: shop4cloud-rbac\n          uri: lb://shop4cloud-rbac\n          predicates:\n            - Path=/shop4cloud_rbac/**\n          filters:\n            - RewritePath=/shop4cloud_rbac(?<segment>/?.*), $\\{segment}\n        - id: shop4cloud-auth\n          uri: lb://shop4cloud-auth\n          predicates:\n            - Path=/shop4cloud_auth/**\n          filters:\n            - RewritePath=/shop4cloud_auth(?<segment>/?.*), $\\{segment}\n        - id: shop4cloud-multishop\n          uri: lb://shop4cloud-multishop\n          predicates:\n            - Path=/shop4cloud_multishop/**\n          filters:\n            - RewritePath=/shop4cloud_multishop(?<segment>/?.*), $\\{segment}\n        - id: shop4cloud-biz\n          uri: lb://shop4cloud-biz\n          predicates:\n            - Path=/shop4cloud_biz/**\n          filters:\n            - RewritePath=/shop4cloud_biz(?<segment>/?.*), $\\{segment}\n        - id: shop4cloud-product\n          uri: lb://shop4cloud-product\n          predicates:\n            - Path=/shop4cloud_product/**\n          filters:\n            - RewritePath=/shop4cloud_product(?<segment>/?.*), $\\{segment}\n        - id: shop4cloud-user\n          uri: lb://shop4cloud-user\n          predicates:\n            - Path=/shop4cloud_user/**\n          filters:\n            - RewritePath=/shop4cloud_user(?<segment>/?.*), $\\{segment}\n        - id: shop4cloud-order\n          uri: lb://shop4cloud-order\n          predicates:\n            - Path=/shop4cloud_order/**\n          filters:\n            - RewritePath=/shop4cloud_order(?<segment>/?.*), $\\{segment}\n        - id: shop4cloud-delivery\n          uri: lb://shop4cloud-delivery\n          predicates:\n            - Path=/shop4cloud_delivery/**\n          filters:\n            - RewritePath=/shop4cloud_delivery(?<segment>/?.*), $\\{segment}\n        - id: shop4cloud-discount\n          uri: lb://shop4cloud-discount\n          predicates:\n            - Path=/shop4cloud_discount/**\n          filters:\n            - RewritePath=/shop4cloud_discount(?<segment>/?.*), $\\{segment}\n        - id: shop4cloud-platform\n          uri: lb://shop4cloud-platform\n          predicates:\n            - Path=/shop4cloud_platform/**\n          filters:\n            - RewritePath=/shop4cloud_platform(?<segment>/?.*), $\\{segment}\n        - id: shop4cloud-search\n          uri: lb://shop4cloud-search\n          predicates:\n            - Path=/shop4cloud_search/**\n          filters:\n            - RewritePath=/shop4cloud_search(?<segment>/?.*), $\\{segment}\n        - id: shop4cloud-coupon\n          uri: lb://shop4cloud-coupon\n          predicates:\n            - Path=/shop4cloud_coupon/**\n          filters:\n            - RewritePath=/shop4cloud_coupon(?<segment>/?.*), $\\{segment}\n        - id: shop4cloud-payment\n          uri: lb://shop4cloud-payment\n          predicates:\n            - Path=/shop4cloud_payment/**\n          filters:\n            - RewritePath=/shop4cloud_payment(?<segment>/?.*), $\\{segment}\n        - id: shop4cloud-group\n          uri: lb://shop4cloud-group\n          predicates:\n            - Path=/shop4cloud_group/**\n          filters:\n            - RewritePath=/shop4cloud_group(?<segment>/?.*), $\\{segment}\n        - id: shop4cloud-seckill\n          uri: lb://shop4cloud-seckill\n          predicates:\n            - Path=/shop4cloud_seckill/**\n          filters:\n            - RewritePath=/shop4cloud_seckill(?<segment>/?.*), $\\{segment}\n        - id: shop4cloud-flow\n          uri: lb://shop4cloud-flow\n          predicates:\n            - Path=/shop4cloud_flow/**\n          filters:\n            - RewritePath=/shop4cloud_flow(?<segment>/?.*), $\\{segment}', '256d52ff10bd08ebf1cb45b6c9a2c8e2', '2020-11-19 06:49:26', '2021-05-21 07:27:40', NULL, '', '', '', '', '', '', 'yaml', '');
...
INSERT INTO `config_info` VALUES (3665, 'service.default.grouplist', 'SEATA_GROUP', '106.14.182.139:8091', '9481e82f38d58591d24335b9ad4aecb5', '2020-11-30 09:43:38', '2021-03-01 07:48:07', NULL, '', '', '4b70485d-72dd-44df-a76a-7a3f578a3001', NULL, NULL, NULL, 'text', NULL);
...
INSERT INTO `config_info` VALUES (3686, 'store.db.url', 'SEATA_GROUP', 'jdbc:mysql://106.14.182.139:3306/shop4cloud_seata?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=GMT%2B8&allowMultiQueries=true&allowPublicKeyRetrieval=true', '2104a66c7d4bb86db640839a10d2c273', '2020-11-30 09:43:40', '2021-06-16 07:57:12', NULL, '', '', '4b70485d-72dd-44df-a76a-7a3f578a3001', '', '', '', 'text', '');
...
INSERT INTO `config_info` VALUES (3716, 'service.vgroupMapping.shop4cloud-auth-seata-service-group', 'SEATA_GROUP', 'default', 'c21f969b5f03d33d43e04f8f136e7682', '2020-11-30 09:55:42', '2020-11-30 09:55:42', NULL, '', '', '4b70485d-72dd-44df-a76a-7a3f578a3001', NULL, NULL, NULL, 'text', NULL);
INSERT INTO `config_info` VALUES (3717, 'service.vgroupMapping.shop4cloud-multishop-seata-service-group', 'SEATA_GROUP', 'default', 'c21f969b5f03d33d43e04f8f136e7682', '2020-11-30 09:57:03', '2020-11-30 09:57:03', NULL, '', '', '4b70485d-72dd-44df-a76a-7a3f578a3001', NULL, NULL, NULL, 'text', NULL);
INSERT INTO `config_info` VALUES (3718, 'service.vgroupMapping.shop4cloud-rbac-seata-service-group', 'SEATA_GROUP', 'default', 'c21f969b5f03d33d43e04f8f136e7682', '2020-11-30 09:57:17', '2020-11-30 09:57:17', NULL, '', '', '4b70485d-72dd-44df-a76a-7a3f578a3001', NULL, NULL, NULL, 'text', NULL);
INSERT INTO `config_info` VALUES (3720, 'service.vgroupMapping.shop4cloud-product-seata-service-group', 'SEATA_GROUP', 'default', 'c21f969b5f03d33d43e04f8f136e7682', '2020-12-01 05:46:53', '2020-12-01 05:46:53', NULL, '', '', '4b70485d-72dd-44df-a76a-7a3f578a3001', NULL, NULL, NULL, 'text', NULL);
INSERT INTO `config_info` VALUES (3721, 'service.vgroupMapping.shop4cloud-biz-seata-service-group', 'SEATA_GROUP', 'default', 'c21f969b5f03d33d43e04f8f136e7682', '2020-12-01 05:47:17', '2020-12-01 05:47:17', NULL, '', '', '4b70485d-72dd-44df-a76a-7a3f578a3001', NULL, NULL, NULL, 'text', NULL);
INSERT INTO `config_info` VALUES (3722, 'service.vgroupMapping.shop4cloud-leaf-seata-service-group', 'SEATA_GROUP', 'default', 'c21f969b5f03d33d43e04f8f136e7682', '2020-12-01 05:47:44', '2020-12-01 05:47:44', NULL, '', '', '4b70485d-72dd-44df-a76a-7a3f578a3001', NULL, NULL, NULL, 'text', NULL);
INSERT INTO `config_info` VALUES (3723, 'service.vgroupMapping.shop4cloud-order-seata-service-group', 'SEATA_GROUP', 'default', 'c21f969b5f03d33d43e04f8f136e7682', '2020-12-01 05:48:00', '2020-12-01 05:48:00', NULL, '', '', '4b70485d-72dd-44df-a76a-7a3f578a3001', NULL, NULL, NULL, 'text', NULL);
INSERT INTO `config_info` VALUES (3724, 'service.vgroupMapping.shop4cloud-user-seata-service-group', 'SEATA_GROUP', 'default', 'c21f969b5f03d33d43e04f8f136e7682', '2020-12-01 05:48:15', '2020-12-01 05:48:15', NULL, '', '', '4b70485d-72dd-44df-a76a-7a3f578a3001', NULL, NULL, NULL, 'text', NULL);
INSERT INTO `config_info` VALUES (3727, 'shop4cloud-order.yml', 'DEFAULT_GROUP', '# 数据源\nspring:\n  datasource:\n    url: jdbc:mysql://${MYSQL_HOST:106.14.182.139}:${MYSQL_PORT:3306}/${MYSQL_DATABASE:shop4cloud_order}?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=GMT%2B8&allowMultiQueries=true&allowPublicKeyRetrieval=true&useAffectedRows=true\n    username: ${MYSQL_USERNAME:root}\n    password: ${MYSQL_PASSWORD:root}', 'c33dca13b41bb90b2477f9ea7228ff48', '2020-12-04 05:45:13', '2021-04-02 12:53:44', NULL, '', '', '', '', '', '', 'yaml', '');
INSERT INTO `config_info` VALUES (3736, 'shop4cloud-user.yml', 'DEFAULT_GROUP', '# 数据源\nspring:\n  datasource:\n    url: jdbc:mysql://${MYSQL_HOST:106.14.182.139}:${MYSQL_PORT:3306}/${MYSQL_DATABASE:shop4cloud_user}?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=GMT%2B8&allowMultiQueries=true&allowPublicKeyRetrieval=true&useAffectedRows=true\n    username: ${MYSQL_USERNAME:root}\n    password: ${MYSQL_PASSWORD:root}', 'a2c60ea7887ebb8a0f6f5f5005048b4b', '2020-12-04 05:51:25', '2021-04-02 12:54:49', NULL, '', '', '', '', '', '', 'yaml', '');
INSERT INTO `config_info` VALUES (3741, 'service.vgroupMapping.shop4cloud-coupon-seata-service-group', 'SEATA_GROUP', 'default', 'c21f969b5f03d33d43e04f8f136e7682', '2020-12-09 01:49:55', '2020-12-09 01:49:55', NULL, '', '', '4b70485d-72dd-44df-a76a-7a3f578a3001', NULL, NULL, NULL, 'text', NULL);
INSERT INTO `config_info` VALUES (3747, 'service.vgroupMapping.shop4cloud-delivery-seata-service-group', 'SEATA_GROUP', 'default', 'c21f969b5f03d33d43e04f8f136e7682', '2020-12-14 03:30:09', '2020-12-14 03:30:09', NULL, '', '', '4b70485d-72dd-44df-a76a-7a3f578a3001', NULL, NULL, NULL, 'text', NULL);
INSERT INTO `config_info` VALUES (3755, 'service.vgroupMapping.shop4cloud-discount-seata-service-group', 'SEATA_GROUP', 'default', 'c21f969b5f03d33d43e04f8f136e7682', '2020-12-16 06:13:14', '2020-12-16 06:13:14', NULL, '', '', '4b70485d-72dd-44df-a76a-7a3f578a3001', NULL, NULL, NULL, 'text', NULL);
INSERT INTO `config_info` VALUES (3759, 'shop4cloud-platform.yml', 'DEFAULT_GROUP', '# 数据源\nspring:\n  datasource:\n    url: jdbc:mysql://${MYSQL_HOST:106.14.182.139}:${MYSQL_PORT:3306}/${MYSQL_DATABASE:shop4cloud_platform}?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=GMT%2B8&allowMultiQueries=true&allowPublicKeyRetrieval=true&useAffectedRows=true\n    username: ${MYSQL_USERNAME:root}\n    password: ${MYSQL_PASSWORD:root}', '274a64e67ef4fab65de1e7b70e0a9ff7', '2020-12-21 07:38:16', '2021-04-02 12:55:59', NULL, '', '', '', '', '', '', 'yaml', '');
INSERT INTO `config_info` VALUES (3761, 'service.vgroupMapping.shop4cloud-platform-seata-service-group', 'SEATA_GROUP', 'default', 'c21f969b5f03d33d43e04f8f136e7682', '2020-12-21 07:41:01', '2020-12-21 07:41:01', NULL, '', '', '4b70485d-72dd-44df-a76a-7a3f578a3001', NULL, NULL, NULL, 'text', NULL);
INSERT INTO `config_info` VALUES (3762, 'service.vgroupMapping.shop4cloud-search-seata-service-group', 'SEATA_GROUP', 'default', 'c21f969b5f03d33d43e04f8f136e7682', '2020-12-22 02:19:51', '2020-12-22 02:19:51', NULL, '', '', '4b70485d-72dd-44df-a76a-7a3f578a3001', NULL, NULL, NULL, 'text', NULL);
INSERT INTO `config_info` VALUES (3812, 'shop4cloud-payment.yml', 'DEFAULT_GROUP', '# 数据源\nspring:\n  datasource:\n    url: jdbc:mysql://${MYSQL_HOST:106.14.182.139}:${MYSQL_PORT:3306}/${MYSQL_DATABASE:shop4cloud_payment}?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=GMT%2B8&allowMultiQueries=true&allowPublicKeyRetrieval=true&useAffectedRows=true\n    username: ${MYSQL_USERNAME:root}\n    password: ${MYSQL_PASSWORD:root}\napplication:\n  domainUrl: http://47.112.182.96:8126/shop4cloud_payment', '2f4b89c096ab0cef9359c98b91ade543', '2021-02-03 03:19:16', '2021-04-02 12:56:14', NULL, '', '', '', '', '', '', 'yaml', '');
INSERT INTO `config_info` VALUES (3814, 'service.vgroupMapping.shop4cloud-payment-seata-service-group', 'SEATA_GROUP', 'default', 'c21f969b5f03d33d43e04f8f136e7682', '2021-02-03 03:20:03', '2021-02-03 03:20:03', NULL, '', '', '4b70485d-72dd-44df-a76a-7a3f578a3001', NULL, NULL, NULL, 'text', NULL);
...
INSERT INTO `config_info` VALUES (4065, 'service.vgroupMapping.shop4cloud-group-seata-service-group', 'SEATA_GROUP', 'default', 'c21f969b5f03d33d43e04f8f136e7682', '2021-03-20 03:01:47', '2021-03-20 03:01:47', NULL, '', '', '4b70485d-72dd-44df-a76a-7a3f578a3001', NULL, NULL, NULL, 'text', NULL);
INSERT INTO `config_info` VALUES (4083, 'service.vgroupMapping.shop4cloud-seckill-seata-service-group', 'SEATA_GROUP', 'default', 'c21f969b5f03d33d43e04f8f136e7682', '2021-04-01 06:18:16', '2021-04-01 06:18:16', NULL, '', '', '4b70485d-72dd-44df-a76a-7a3f578a3001', NULL, NULL, NULL, 'text', NULL);
INSERT INTO `config_info` VALUES (4115, 'service.vgroupMapping.shop4cloud-flow-seata-service-group', 'SEATA_GROUP', 'default', 'c21f969b5f03d33d43e04f8f136e7682', '2021-05-22 02:36:39', '2021-05-22 02:36:39', NULL, '', '', '4b70485d-72dd-44df-a76a-7a3f578a3001', NULL, NULL, NULL, 'text', NULL);
...
create database IF NOT EXISTS `shop4cloud_order` default character set utf8 collate utf8_general_ci;

USE shop4cloud_order;
...
create database IF NOT EXISTS `shop4cloud_payment` default character set utf8 collate utf8_general_ci;

USE shop4cloud_payment;
...
create database IF NOT EXISTS `shop4cloud_platform` default character set utf8 collate utf8_general_ci;

USE shop4cloud_platform;
...
create database IF NOT EXISTS `shop4cloud_product` default character set utf8 collate utf8_general_ci;

USE shop4cloud_product;
...
create database IF NOT EXISTS `shop4cloud_rbac` default character set utf8 collate utf8_general_ci;
...
create database IF NOT EXISTS `shop4cloud_seata` default character set utf8 collate utf8_general_ci;

USE shop4cloud_seata;
...
create database IF NOT EXISTS `shop4cloud_user` default character set utf8 collate utf8_general_ci;
